		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="text" name="name" id="firstname" class="form-control" value="<?=$profile['name'] ?>" required>
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="email" name="email" id="email" class="form-control" value="<?=$profile['email'] ?>" required  autocomplete="off">
				</div>
                <div class="form-group">
					<label for="username">Contact</label>
					<input type="text" name="contact" id="contact" class="form-control" value="<?=$profile['contact'] ?>" required  autocomplete="off">
				</div>
                <div class="form-group">
					<label for="username">Gender</label>
					<select type="text" name="gender" id="gender" class="form-control"  required  autocomplete="off">
                    <option <?=$profile['gender']=='Male' ? ' selected' : '';?>>Male</option>
                    <option <?=$profile['gender']=='Female' ? ' selected' : '';?>>Female</option>
                    </select>
				</div>
                <?php 
                 $dt = new DateTime($profile['birthdate'] );
                ?>
                <div class="form-group">
					<label for="username">Address</label>
					<input type="text" name="address" id="address" class="form-control" value="<?=$profile['address'] ?>" required  autocomplete="off">
				</div>
                <div class="form-group">
                <label for="bdate" class="control-label">Date of Birth</label>
                <input type="date" class="form-control" name="birthdate" id = "bdate" value="<?=$dt->format('Y-m-d') ?>" required>
            </div>
				<div class="form-group">
...
var _this = $(this)
        ...
        console.log("ahuah")
		$.ajax({
			url:'<?=site_url('Patient/update_profile/')?>',
